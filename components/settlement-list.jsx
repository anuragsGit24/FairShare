  ...
  return (
    <div className="flex flex-col gap-4">
      {settlements.map((settlement) => {
        ...
        const isCurrentUserPayer = currentUser && settlement.paidByUserId === currentUser._id;
        const isCurrentUserReceiver = currentUser && settlement.receivedByUserId === currentUser._id;
