...
const ContactsPage = () => {
  ...
  const {contacts: users, groups} = data || {contacts: [], groups: []};
          ...
          {users.length === 0 ? (
            <Card>
              <CardContent className="py-6 text-center text-muted-foreground">
                No individual contacts found. Add an expense to see them here.
              </CardContent>
            </Card>
          ) : (
                      ...
                      <div className='flex items-center justify-between'>
                        <div className='flex items-center gap-3'>
                          ...
                          <div>
                            ...
                            <p className='text-sm text-muted-foreground'>{group.memberCount} members
                            </p>
                          </div>
